...
const ummaPhotos = [
  { 
    imageUrl: '/lovable-uploads/f32e528f-722b-40dd-b946-8526a4944be4.png', 
    name: 'Umma Casual 1' 
  },
  { 
    imageUrl: '/lovable-uploads/dc1cac60-4e59-4985-a216-f801a850a7e4.png', 
    name: 'Umma Casual 2' 
  },
  { 
    imageUrl: '/lovable-uploads/ad85baa8-cb98-46da-9993-46f927d04ffe.png', 
    name: 'Umma Elegante 1' 
  },
  { 
    imageUrl: '/lovable-uploads/c42e08fc-23ba-4f47-a351-71449ddd6081.png', 
    name: 'Umma Elegante 2' 
  },
  { 
    imageUrl: '/lovable-uploads/5ecec764-3fc0-4e73-b8c4-04d26127c527.png', 
    name: 'Umma Moderna 1' 
  },
  { 
    imageUrl: '/lovable-uploads/8b07bb88-e3c2-4b99-8b8d-7509f0bf14e3.png', 
    name: 'Umma Moderna 2' 
  },
  { 
    imageUrl: '/lovable-uploads/7fdcbc2d-c934-42ee-a6ad-6f974b26ceb5.png', 
    name: 'Umma Dulce 1' 
  },
  { 
    imageUrl: '/lovable-uploads/f9f1c37d-13c7-4ccb-8bd9-7ed41b1f9ea4.png', 
    name: 'Umma Quinceañera 1' 
  }
];
...
export const MemoryGame: React.FC = () => {
  ...
  const initializeGame = () => {
    const selectedPhotos = ummaPhotos.slice(0, totalPairs);
          ...
          <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
            <div className="bg-black/80 rounded-lg p-6 max-w-md w-full max-h-[80vh] overflow-y-auto">
              ...
              <div className="grid grid-cols-3 gap-2">
                {ummaPhotos.slice(0, totalPairs).map((item, index) => (
