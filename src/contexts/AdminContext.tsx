...
const defaultGameConfigs: { [key: string]: GameConfig } = {
  ...
  'trivia': {
    ...
    customSettings: {
      questions: [
        {
          question: "¿Cuánto mide Uma?",
          options: ["1.64m", "1.60m", "1.67m"],
          correct: 0
        },
        {
          question: "¿Cuál es el sabor de helado favorito de Uma?",
          options: ["Chocolate", "Frutilla y granizado", "Dulce de leche"],
          correct: 1
        },
        {
          question: "¿Cuál es la estación del año favorita de Uma?",
          options: ["Invierno", "Otoño", "Verano"],
          correct: 2
        },
        {
          question: "¿Qué día de la semana nació Uma?",
          options: ["Viernes", "Sábado", "Domingo"],
          correct: 0
        },
        {
          question: "¿A qué hora nació Uma?",
          options: ["10:30 de la mañana", "11:50 del mediodía", "2:15 de la tarde"],
          correct: 1
        },
        {
          question: "¿Cuántas mascotas ha tenido Uma?",
          options: ["2 mascotas", "4 mascotas", "3 mascotas"],
          correct: 2
        },
        {
          question: "¿Cuál es la comida favorita de Uma?",
          options: ["Fajitas", "Pizza", "Hamburguesas"],
          correct: 0
        },
        {
          question: "¿Cuál es el hobby favorito de Uma?",
          options: ["Leer libros", "Ir al gimnasio", "Ver películas"],
          correct: 1
        },
        {
          question: "¿En qué momento del día nació Uma?",
          options: ["Por la mañana", "Por la tarde", "Al mediodía"],
          correct: 2
        },
        {
          question: "¿Qué tipo de actividad física prefiere Uma?",
          options: ["Gimnasio", "Natación", "Correr"],
          correct: 0
        },
        {
          question: "¿Qué sabor NO es favorito de Uma en helados?",
          options: ["Menta", "Chocolate", "Frutilla"],
          correct: 1
        },
        {
          question: "¿Cuántos centímetros mide Uma exactamente?",
          options: ["160 cm", "167 cm", "164 cm"],
          correct: 2
        },
        {
          question: "¿En qué estación del año Uma NO se siente más cómoda?",
          options: ["Otoño", "Invierno", "Primavera"],
          correct: 1
        },
        {
          question: "¿Qué comida internacional prefiere Uma?",
...
const defaultConfig: AdminConfig = {
  ...
  puzzleImage: 'https://images.unsplash.com/photo-1582562124811-c09040d0a901?w=400&h=400&fit=crop',
